...
from routers import funds, donations, subscriptions, campaigns, zakat, reports, auth
...
app = FastAPI(
    ...
    description="API для благотворительности MubarakWay",
    version="1.0.0",
    lifespan=lifespan
)
...
@app.get("/")
async def root():
    return {"message": "Садака-Пасс API", "status": "running"}
